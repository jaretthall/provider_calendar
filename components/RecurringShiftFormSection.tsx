    ...
    <div className="space-y-4 p-4 border border-gray-200 rounded-md mt-4">
      ...
      <div>
        ...
        <select
          ...
          className="mt-1 block w-full pl-3 pr-10 py-2 text-base bg-gray-50 border-2 border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:bg-white sm:text-sm rounded-md"
        >
