...
-- This is for demo purposes and will only be visible to the user who creates it

-- Example providers (these will be created per-user due to RLS)
-- Users will need to create their own data after signing up 